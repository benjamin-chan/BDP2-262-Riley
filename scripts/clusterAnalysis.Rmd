...
* Cluster 1 ($`r sprintf("n = %d", dianaXMetrics[["hcut"]][["size"]][1])`$) has
  * Low ECBI scores
  * High *positive* MAPS scores
  * High SEPTI scores
* Cluster 2 ($`r sprintf("n = %d", dianaXMetrics[["hcut"]][["size"]][2])`$) has
  * High ECBI scores
  * High *negative* MAPS scores
  * Low SEPTI scores
* Cluster 3 ($`r sprintf("n = %d", dianaXMetrics[["hcut"]][["size"]][3])`$) is the outlier; have low positive and low negative MAPS scores
