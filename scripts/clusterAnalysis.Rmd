...
`r sprintf("%.03f", dianaYPCB[["hcut"]][["silinfo"]][["avg.width"]])`.
...
Average silhouette width is 
`r sprintf("%.03f", dianaXMetrics[["hcut"]][["silinfo"]][["avg.width"]])`.
...
Average silhouette width is 
`r sprintf("%.03f", dianaXParentChild[["hcut"]][["silinfo"]][["avg.width"]])`.
...
Average silhouette width is 
`r sprintf("%.03f", dianaXDemog[["hcut"]][["silinfo"]][["avg.width"]])`.
